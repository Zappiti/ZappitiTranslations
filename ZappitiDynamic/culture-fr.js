var cultureFr = new Array();
cultureFr.EmptyMenu = "Ce menu est vide.";
cultureFr.SearchResultFor = "R&eacute;sultats pour : ";
cultureFr.NoSearchResult = "Aucun r&eacute;sultat trouv&eacute;.";
cultureFr.ConnectionTitle = "Connexion en cours";
...
cultureFr.AudioHelpDefault = "audio-help-default-fr.jpg";
cultureFr.Yes = "Oui";
cultureFr.No = "Non";
cultureFr.OK = "OK";
...
cultureFr.Keyboard = {
            ...
            'control': [
                ...
                [
                    { "caption": "Effacer", "cmdClear": 1 }
                ],
                [
                    { "caption": "Symboles", 'cmdShow': 'symbols' }
                ],
                [
                    { "caption": "Entr&eacute;e", 'cmdSubmit': 1 }
                ]
            ],
            ...
            'control-up': [
                ...
                [
                    { "caption": "Symboles", 'cmdShow': 'symbols-up' }
                ],
                [
                    { "caption": "Entr&eacute;e", 'cmdSubmit': 1 }
                ]
